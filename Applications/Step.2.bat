...
if %var2.3%==yes echo .
if %var2.3%==yes echo "Starting Windows Feature Update Script"
if %var2.3%==yes Powershell.exe -executionpolicy unrestricted -File "%cpath%\Default\Install Windows 10 Feature Update.ps1"
